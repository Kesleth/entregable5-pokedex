      ...
      <section>
        <article>
          ...
          <form className="grid sm:px-20" onSubmit={handleSubmit}>
            <input
              className="mt-10 p-4 outline-none opacity-80 rounded-lg shadow-lg shadow-red-500 px-6"
              id="nameTrainer"
              type="text"
              placeholder="Your name..."
            />
            <button className="mt-8 bg-red-600/80 mx-auto p-3 rounded-lg text-black font-['Akshar'] transition transform hover:-translate-y-4 motion-reduce:transition-none motion-reduce:hover:transform-none duration-300 mb-10">
              start!
            </button>
          </form>
        </article>
